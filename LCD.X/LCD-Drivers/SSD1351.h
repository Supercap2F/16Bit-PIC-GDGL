 ...
 *      D0:7 are on PORTE
 */
#define dis_RES  LATBbits.LATB4
#define dis_CS   LATAbits.LATA2
#define dis_D_C  LATAbits.LATA3
#define dis_E_RD LATBbits.LATB7
#define dis_R_W  LATBbits.LATB6

#define dis_EN   LATBbits.LATB5
